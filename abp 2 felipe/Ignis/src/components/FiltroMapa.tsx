...
// 🔥 Componente SliderToggle usado nos novos botões
...
const FiltroMapa: React.FC<FiltroMapaProps> = ({ onFiltrar }) => {
      ...
      <Filtros>
        ...
        <SliderToggle
          ...
          onClick={() => {
            ...
            // Se o "Risco de Fogo" já estava ligado, desligamos e voltamos à página inicial
  ...
  active={riscoDeFogo}
  onClick={() => {
    // Se o "Risco de Fogo" está desligado, ligamos ele e navegamos
    if (!riscoDeFogo) {
      setFocoDeCalor(false);
      setAreaDeQueimada(false);
      setRiscoDeFogo(true);
...
// 🔥 Estilos no final do FiltroMapa.tsx
